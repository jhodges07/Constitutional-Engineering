...
Govern Cursor AI operational boundaries, execution gates, and implementation discipline.
...
1. Identifier `STD-003` is allocated and shall not be reused for a different standard subject.  
2. Normative body content is not yet authored.  
3. Until Status becomes Active, operators shall follow ARCH-001, POL-001, WF-001, and active AI boundary rules.  
