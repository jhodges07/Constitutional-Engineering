...
Govern repository structure, stewardship interfaces, and multi-repository coordination practice.
...
1. Identifier `STD-006` is allocated and shall not be reused for a different standard subject.  
2. Normative body content is not yet authored.  
3. Until Status becomes Active, operators shall follow ARCH-001/003/004, POL-001 stewardship rules, and WF-002 multi-repo release coordination.  
