...
Govern audit package requirements complementary to STD-015 and release audits under WF-002.
...
1. Identifier `STD-013` is allocated and shall not be reused for a different standard subject.  
2. Normative body content is not yet authored.  
3. Until Status becomes Active, operators shall follow STD-015 CER rules and WF-002 pre-release audit requirements.  
