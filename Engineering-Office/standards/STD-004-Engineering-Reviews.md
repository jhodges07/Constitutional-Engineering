...
Govern engineering review types, evidence, and acceptance criteria for Office artifacts.
...
1. Identifier `STD-004` is allocated and shall not be reused for a different standard subject.  
2. Normative body content is not yet authored.  
3. Until Status becomes Active, operators shall follow WF-001 review/acceptance gates and applicable Active standards.  
