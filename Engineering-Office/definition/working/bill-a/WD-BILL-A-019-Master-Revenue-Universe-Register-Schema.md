...
**Status:** WORKING / CANDIDATE SCHEMA LOCKED — REGISTER **EMPTY** — NOT ACCEPTED  
**Version:** 0.1.0  
...
REGISTER NOT POPULATED
AUDIT NOT EXECUTED
NO KANSAS-LAW FINDINGS
NO FISCAL QUANTITIES
...
This CWC does **not** answer it. Motor fuel remains the example of the uniform surviving-excise standard and is **not RETAINED**.
